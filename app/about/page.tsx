            ...
            <Card>
              <div className="p-6 flex flex-col gap-2">
                <p className="text-zinc-300">
                  Hey there! I'm David Kehl, a Senior Full Stack Software
                  Engineer with a passion for creating innovative solutions and
                  pushing the boundaries of technology. You can find me diving
                  into coding projects, either at work or on my own platform,
                  Beacon, which I founded to support veterans and service
                  members facing mental health challenges.
                </p>
                <p className="text-zinc-300">
                ...
                <p className="text-zinc-300">
                  ...
                  Mentor at Sabio School of Software Engineering, where I
                  crafted comprehensive curricula and fostered a collaborative
                  learning environment, to my role as a Senior Software Engineer
                  at Letter B LLC, where I spearheaded the delivery of complex
                  solutions and integrated cutting-edge technologies.
                </p>
                <p className="text-zinc-300">
                ...
                <p className="text-zinc-300">
                  ...
                  professional journey on LinkedIn at
                  www.linkedin.com/in/dmkehl, or check out my portfolio at
                  davidkehl.com. For a glimpse of my coding adventures, you can
                  find me on GitHub at github.com/dmkehl.
                </p>
                <p className="text-zinc-300">
